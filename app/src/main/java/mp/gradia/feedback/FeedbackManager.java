...
public class FeedbackManager {
    ...
    public static List<FeedbackAdvice> generateTemperalAdvice(Optional<FeedbackAnalysis> recentAnalysis,
        ...
        Map<String, Integer> overallSubjectTime = overallAnalysisValue.getSubjectStudyTime();
        Map<String, Integer> recentSubjectTime = recentAnalysisValue.getSubjectStudyTime();
        ...
        List<Map.Entry<String, Integer>> toSort = new ArrayList<>(overallSubjectTime.entrySet());
